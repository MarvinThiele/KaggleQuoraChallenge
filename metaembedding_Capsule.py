...
# This step effectivly steals some data from the algorithm, but useful to make it fair to compare
train, _ = train_test_split(train, test_size=0.05, random_state=1338)
